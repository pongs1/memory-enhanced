...
export async function executeMemoryConsolidate(
    ...
    const summary = [
        ...
        output.buildStats
            ? `buildScope=hot:${output.buildStats.hotDocs} cold:${output.buildStats.coldDocs} removed:${output.buildStats.removedDocs} reusedCache:${output.buildStats.reusedCache} noopReuse:${output.buildStats.noopReuse} partial:${output.buildStats.partialBuild} sourceWrites:${output.buildStats.sourceNarrativeWrittenFiles} sourceSkips:${output.buildStats.sourceNarrativeSkippedFiles} sourceAppendOnlySkips:${output.buildStats.sourceNarrativeAppendOnlySkippedFiles}`
            : null,
        output.buildStats

...
function buildPrompt(input: {
    ...
    const allowedLine = allowed.length
        ...
        : "";
    return [
        "## V8 IR Extraction Task",
        "",
        "Extract memory items from the unit below. Use only relations allowed for this layer.",
        ...
        "Only include items directly supported by the evidence spans.",
        "",
        allowedLine,
        "",
        "### Unit",
